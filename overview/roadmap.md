...
* Email notifications using SendGrid or Gmail. This has currently the **highest priority**. Example: You will be receiving email notifications when an issue's status changes or due date expires.
