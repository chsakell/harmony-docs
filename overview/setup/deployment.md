...
{% hint style="warning" %}
Don't forget to set the <mark style="color:orange;">signalrHostUrl</mark> property in the **appsettings.Production.json** file existing in the **Harmony.Client** project _(www folder)_ which configures the **Harmony.Server.SignalR** project's host URL for clients!
{% endhint %}
